...
class DeepQNetwork():
    ...
    def __init__(self, state_dim, action_dim):
        ...
        self.l1=nn.Parameter(self.state_size,120)
        self.b1=nn.Parameter(1,120)
        self.l2=nn.Parameter(120,60)
        self.b2=nn.Parameter(1,60)
        self.l3=nn.Parameter(60,self.num_actions)
        self.b3=nn.Parameter(1,self.num_actions)
    

        self.set_weights([self.l1, self.b1, self.l2, self.b2,self.l3,self.b3])
    ...
    def run(self, states):
        ...
        res=nn.Linear(states, self.l1)
        res=nn.AddBias(res, self.b1)
        res=nn.ReLU(res)
        res=nn.Linear(res, self.l2)
        res=nn.AddBias(res, self.b2)
        res=nn.ReLU(res)
        res=nn.Linear(res, self.l3)
        res=nn.AddBias(res, self.b3)
